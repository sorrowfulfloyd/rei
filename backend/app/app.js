...
app.use("/devices", auth, deviceRoute);
...
app.use("/uptime", async (req, res) => {
	...
	const health = {
		"Server Status": "OK",
		"MongoDB Status": (await mongoDB).STATES[
			(await mongoDB).connection.readyState
		],
...
function auth(req, res, next) {
	...
	} // TODO: don't forget to change this to get cookies from browser
	next();
}
